...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-lg border bg-card text-card-foreground shadow-sm transition-all duration-200 hover:shadow-md dark:bg-gray-800 dark:border-gray-700 dark:shadow-gray-900/10 dark:hover:shadow-gray-900/20",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("flex items-center p-6 pt-0 dark:text-gray-100", className)}
    {...props}
  />
))
